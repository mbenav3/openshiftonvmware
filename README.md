...
1. Run the playbook below to configure an NFS server in the bastion node

    ```console
    ansible-playbook tasks/nfs-setup.yml
    ```
...
From the menu items, select the bootstrap node
